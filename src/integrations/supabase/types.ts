    ...
    Tables: {
      ...
      comanda_locks: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "comanda_locks_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      complements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "complements_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      nfce_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "nfce_records_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      order_item_complements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "order_item_complements_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      self_service_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "self_service_sessions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      table_activity_log: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "table_activity_log_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
